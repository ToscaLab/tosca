...
mod tests {
    ...
    fn create_routes() -> Routes {
        Routes {
            increase_temp: Route::put("Increase temperature", "/increase-temperature")
            ...
            decrease_temp: Route::put("Decrease temperature", "/decrease-temperature")
            ...
            increase_temp_post: Route::post("Increase temperature", "/increase-temperature")
                .description("Increase temperature.")
                .with_slice_hazards(&[Hazard::ElectricEnergyConsumption, Hazard::SpoiledFood])
                .with_parameters(Parameters::new().rangef64_with_default(
                    "increment",
